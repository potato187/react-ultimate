				...
				<Navbar.Collapse id='basic-navbar-nav'>
					...
					<Nav>
						{!isAuthenticated ? (
							...
							<NavDropdown title='Setting' className={style['dropdown']}>
								<NavDropdown.Item className={style['dropdown-item']}>Profiles</NavDropdown.Item>
								<NavDropdown.Item className={style['dropdown-item']} onClick={handleLogOut}>
									Logout
								</NavDropdown.Item>
							</NavDropdown>
						)}
